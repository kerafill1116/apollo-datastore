...
<fmt:setBundle basename="apollo.datastore.utils.i18n.ChangeEmailAddressBundle" var="changeEmailAddressBundle" />
...
function inputChangeHandler(event) {
    changeEmailAddressFormValidator.element(event.currentTarget);
}
