...
<html>
    <head>
        ...
        <title><fmt:message key="title_register_thank_you" bundle="${utilities}" /></title>
        <!-- Bootstrap -->
...
<%@ include file="/WEB-INF/jspf/pub/top-navbar.jspf" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-offset-2 col-sm-8">
                        <div class="row"><h3 class="col-xs-12 col-sm-12"><fmt:message key="page_header_register_thank_you" bundle="${utilities}" /></h3></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-sm-offset-2 col-sm-8">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12"><fmt:message key="message_register_thank_you" bundle="${utilities}" /></div>
                    </div>
                </div>
            </div>
        </div>
