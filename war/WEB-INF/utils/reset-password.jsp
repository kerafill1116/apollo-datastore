...
<html>
    <head>
        ...
        <title><fmt:message key="title_reset_password_request" bundle="${utilities}" /></title>
        <!-- Bootstrap -->
                ...
                <div class="col-xs-12 col-sm-offset-2 col-sm-8">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12 col-sm-offset-3 col-sm-8">
                            <input id="submit-btn" type="submit" class="btn btn-default" value="<fmt:message key='reset_password_button' bundle='${utilities}' />" />
...
<c:if test="${errorVariable.value ne errorNone.code}">
    ...
    <c:choose>
        ...
        <c:when test="${errorVariable.value eq errorInResetPasswordRequest.code}" >
            <fmt:message key="message_error_in_reset_password_request" bundle="${errorMessages}" var="errorMessage" />
        </c:when>
        <c:otherwise>
