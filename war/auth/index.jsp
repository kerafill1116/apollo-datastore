...
<fmt:setBundle basename="apollo.datastore.i18n.AuthBundle" var="auth" />
...
<html>
    <head>
        ...
        <title><fmt:message key="title_index_jsp" bundle="${auth}" /></title>
        <!-- Bootstrap -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-offset-2 col-sm-8">
                        <div class="row">
                            <h3 class="col-xs-12 col-sm-12"><fmt:message key="page_header_index_jsp" bundle="${auth}" /></h3>
                        </div>
                    </div>
                </div>
            </div>
